...
struct CrawlSignalMain {
    static func main() async throws {
        ...
        try await server.registerTool(submitTool) { params in
        ...
        try await server.registerTool(perplexityTool) { params in
            let args = params.arguments ?? [:]
        ...
        try await server.registerTool(auditTool) { params in
            let args = params.arguments ?? [:]
            let url = args["url"]?.stringValue ?? ""
